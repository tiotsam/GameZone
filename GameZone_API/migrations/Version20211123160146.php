 ...
 */
final class Version20211123160146 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, adress_facturation VARCHAR(255) NOT NULL, adresse_livraison VARCHAR(255) NOT NULL, quantité INT NOT NULL, date_commande DATE NOT NULL, INDEX IDX_6EEAA67DA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE medias (id INT AUTO_INCREMENT NOT NULL, produit_id INT DEFAULT NULL, type VARCHAR(255) NOT NULL, lien VARCHAR(255) NOT NULL, INDEX IDX_12D2AF81F347EFB (produit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
